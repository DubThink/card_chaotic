...
public class UICardView3 extends UIBase {
    public Card card;
    ...
    public UICardView3(int x, int y, float scaler, UILayer layer) {
    ...
    protected void _draw(AdvancedApplet p) {
        ...
        if(card!=null){
            ...
            Style.getFont(Style.F_FLAVOR,Style.FONT_33).apply(p);
            p.textSize(12);
            p.textAlign(LEFT);
    ...
    public UICardView3 setCardView(Card card, boolean readonly){
        this.card = card;
        this.readonly = readonly;
        return this;
    }

    public UICardView3 setCardDefinitionView(CardDefinition definition){
