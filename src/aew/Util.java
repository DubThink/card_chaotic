 ...
 * @author Abby Welsh on 4/12/2017.
 */
public class Util {
    // CONSTS
    ...
    public static void main(String[] args) {
        ...
        System.out.println("proprotionally between test");
        System.out.println(proportionallyBetween(1,2,1,2));
        System.out.println(proportionallyBetween(0,2,1,2));
        System.out.println(proportionallyBetween(-1,1,0,1));
...
//    public static Vector2 halfBetween(Vector2 a, Vector2 b){
//        return new Vector2(halfBetween(a.x,b.x),halfBetween(a.y,b.y));
//    }

    public static float halfBetween(float a, float b){
        return a+((b-a)/2.0f);
    }
    public static float proportionallyBetween(float pa, float pb, float a, float b){
        return a+((b-a)*(pb/(pa+pb)));
    }
